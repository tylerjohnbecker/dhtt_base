...
main communication to manipulate and get information from the d\+H\+TT  
...
\begin{center}
\leavevmode
\includegraphics[width=178pt]{classdhtt_1_1MainServer__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=178pt]{classdhtt_1_1MainServer__coll__graph}
\end{center}
\end{figure}
...
std\+::vector$<$ dhtt\+\_\+msgs\+::msg\+::\+Subtree $>$ \mbox{\hyperlink{classdhtt_1_1MainServer_a5379d04ccfa083c00ee9c605debe64d0}{fetch\+\_\+subtrees\+\_\+by\+\_\+common\+\_\+name}} (std\+::string name)
...
std\+::vector$<$ dhtt\+\_\+msgs\+::msg\+::\+Subtree $>$ \mbox{\hyperlink{classdhtt_1_1MainServer_a817f8a49d4bdf7eb0f1e39611986850a}{fetch\+\_\+subtrees\+\_\+by\+\_\+type}} (int type)
...
\begin{DoxyCompactList}\small\item\em subthread function to send the run goal to the d\+H\+TT \end{DoxyCompactList}\item 
...
std\+::vector$<$ dhtt\+\_\+msgs\+::msg\+::\+Node $>$ \mbox{\hyperlink{classdhtt_1_1MainServer_aa6984433097e6aa902ee8b8fff43f035}{get\+\_\+active\+\_\+nodes}} ()
\begin{DoxyCompactList}\small\item\em Returns a list of all nodes that have status A\+C\+T\+I\+VE. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{classdhtt_1_1MainServer}{Main\+Server}} contains the d\+H\+TT and facilitates any modification requests in four main categories\+:
\begin{DoxyItemize}
...
\hline
{\em spinner} & outside multithreaded executor which new nodes that are created in the d\+H\+TT will be added to \\
\hline
\end{DoxyParams}
...
N\+OT I\+M\+P\+L\+E\+M\+E\+N\+T\+ED Y\+ET
...
\end{DoxyReturn}
\mbox{\Hypertarget{classdhtt_1_1MainServer_a5379d04ccfa083c00ee9c605debe64d0}\label{classdhtt_1_1MainServer_a5379d04ccfa083c00ee9c605debe64d0}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{classdhtt_1_1MainServer_a817f8a49d4bdf7eb0f1e39611986850a}\label{classdhtt_1_1MainServer_a817f8a49d4bdf7eb0f1e39611986850a}} 
...
This performs a linear search of the nodes in the tree and returns the first that is a B\+E\+H\+A\+V\+I\+OR type node and has an A\+C\+T\+I\+VE status. Returns a node with name \char`\"{}failed\char`\"{} if the tree if one is not found.

\begin{DoxyReturn}{Returns}
internal representation of the active node 
\end{DoxyReturn}
\mbox{\Hypertarget{classdhtt_1_1MainServer_aa6984433097e6aa902ee8b8fff43f035}\label{classdhtt_1_1MainServer_aa6984433097e6aa902ee8b8fff43f035}} 
...
Returns a list of all nodes that have status A\+C\+T\+I\+VE. 
...
Makes necessary changes to the internal representation of the d\+H\+TT after a node is added or removed.
...
subthread function to send the run goal to the d\+H\+TT 
