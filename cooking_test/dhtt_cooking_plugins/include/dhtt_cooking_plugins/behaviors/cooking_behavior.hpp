...
class CookingBehavior : public dhtt_plugins::ActionType
{
  ...
  protected:
	...
	dhtt_cooking_msgs::msg::CookingObject destination_object; // closest object
	...
	void observation_callback(std::shared_ptr<dhtt_cooking_msgs::msg::CookingObservation> msg);
	...
	char check_mark(const dhtt_cooking_msgs::msg::CookingObject &obj) const;
	...
	bool unmark_static_object_under_obj(const dhtt_cooking_msgs::msg::CookingObject &obj, bool force=false) const;
	...
	std::shared_ptr<dhtt_cooking_msgs::msg::CookingObservation> last_obs;
