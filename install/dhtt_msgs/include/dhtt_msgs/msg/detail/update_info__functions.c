...
dhtt_msgs__msg__UpdateInfo__init(dhtt_msgs__msg__UpdateInfo * msg)
{
  ...
  // updates
  if (!dhtt_msgs__msg__Pair__Sequence__init(&msg->updates, 0)) {
    dhtt_msgs__msg__UpdateInfo__fini(msg);
    return false;
  }
  return true;
}
...
dhtt_msgs__msg__UpdateInfo__fini(dhtt_msgs__msg__UpdateInfo * msg)
{
  ...
  // updates
  dhtt_msgs__msg__Pair__Sequence__fini(&msg->updates);
}
...
dhtt_msgs__msg__UpdateInfo__create()
{
  ...
  dhtt_msgs__msg__UpdateInfo * msg = (dhtt_msgs__msg__UpdateInfo *)allocator.allocate(sizeof(dhtt_msgs__msg__UpdateInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dhtt_msgs__msg__UpdateInfo));
  bool success = dhtt_msgs__msg__UpdateInfo__init(msg);
  if (!success) {
...
dhtt_msgs__msg__UpdateInfo__Sequence__init(dhtt_msgs__msg__UpdateInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dhtt_msgs__msg__UpdateInfo * data = NULL;

  if (size) {
    data = (dhtt_msgs__msg__UpdateInfo *)allocator.zero_allocate(size, sizeof(dhtt_msgs__msg__UpdateInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dhtt_msgs__msg__UpdateInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dhtt_msgs__msg__UpdateInfo__fini(&data[i - 1]);
      }
...
dhtt_msgs__msg__UpdateInfo__Sequence__fini(dhtt_msgs__msg__UpdateInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dhtt_msgs__msg__UpdateInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dhtt_msgs__msg__UpdateInfo__Sequence * array = (dhtt_msgs__msg__UpdateInfo__Sequence *)allocator.allocate(sizeof(dhtt_msgs__msg__UpdateInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dhtt_msgs__msg__UpdateInfo__Sequence__init(array, size);
  if (!success) {
...
dhtt_msgs__msg__UpdateInfo__Sequence__destroy(dhtt_msgs__msg__UpdateInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dhtt_msgs__msg__UpdateInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dhtt_msgs__msg__UpdateInfo__Sequence__are_equal(const dhtt_msgs__msg__UpdateInfo__Sequence * lhs, const dhtt_msgs__msg__UpdateInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dhtt_msgs__msg__UpdateInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dhtt_msgs__msg__UpdateInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dhtt_msgs__msg__UpdateInfo);
    dhtt_msgs__msg__UpdateInfo * data =
      (dhtt_msgs__msg__UpdateInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dhtt_msgs__msg__UpdateInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dhtt_msgs__msg__UpdateInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dhtt_msgs__msg__UpdateInfo__copy(
