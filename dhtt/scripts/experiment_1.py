...
class ServerNode (rclpy.node.Node):
	...
	def run_experiment(self):
		...
		topmost_then.node_name = "TopmostThen"
		topmost_then.plugin_name = "dhtt_plugins::ThenBehavior"
		topmost_then.type = Node.THEN

		self.add_node(topmost_then, 'ROOT_0')

		assigned_name = self.get_node_from_partial_name('TopmostThen')

		self.add_pick_place_to('PickPlace1', 'home', 'depot_1', 10, assigned_name)
		self.add_pick_place_to('PickPlace2', 'home', 'depot_3', 10, assigned_name)
		self.add_pick_place_to('PickPlace3', 'home', 'depot_5', 10, assigned_name)

		self.start_tree()

		self.wait_for_node_in_state('PickPlace1', NodeStatus.WORKING)

		assigned_name = self.get_node_from_partial_name('PickPlace2')
		self.remove_node( assigned_name )

		assigned_name = self.get_node_from_partial_name('PickPlace3')
		self.remove_node( assigned_name )

		assigned_name = self.get_node_from_partial_name('TopmostThen')

		self.add_pick_place_to('PickPlace4', 'home', 'depot_4', 10, assigned_name)
		self.add_pick_place_to('PickPlace3', 'home', 'depot_5', 10, assigned_name)
		self.add_pick_place_to('PickPlace2', 'home', 'depot_3', 10, assigned_name)
