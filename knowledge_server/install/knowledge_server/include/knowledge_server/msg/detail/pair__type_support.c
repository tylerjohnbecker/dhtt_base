  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  knowledge_server__msg__Pair__init(message_memory);
}

void Pair__rosidl_typesupport_introspection_c__Pair_fini_function(void * message_memory)
{
  knowledge_server__msg__Pair__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pair__rosidl_typesupport_introspection_c__Pair_message_member_array[2] = {
  {
    ...
    offsetof(knowledge_server__msg__Pair, key),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(knowledge_server__msg__Pair, value),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Pair__rosidl_typesupport_introspection_c__Pair_message_members = {
  ...
  "Pair",  // message name
  2,  // number of fields
  sizeof(knowledge_server__msg__Pair),
